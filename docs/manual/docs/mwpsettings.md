...
| mavlink-sysid | Sysid for synthesised MAVLink | System ID in the range 2-255 (<a href="https://ardupilot.org/dev/docs/mavlink-basics.html#message-format">MAVlink documentation</a> and particularly the GCS guidance, 2nd paragraph _ibid_) | 106 |
