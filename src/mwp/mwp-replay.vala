...
public class ReplayThread : GLib.Object {
	...
	*/
    ...
    private size_t serialise_analog2(MSP_ANALOG2 b, uint8 []tx) {
        uint8 *p = tx;
		SEDE.serialise_u16(p+1, b.vbat);
		SEDE.serialise_u16(p+3, b.amps);
		SEDE.serialise_u32(p+9, b.mahdraw);
		p = SEDE.serialise_u16(p+22, b.rssi);
        return (p - &tx[0]);
    }
