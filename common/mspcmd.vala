...
public class MSP : Object
{
    ...
    public static string to_string(MSP.Cmds c)
    {
        string s;
        switch(c)
        {
            ...
            case MSP.Cmds.SET_PID:
                s="MSP_SET_PID";
                break;
            case MSP.Cmds.ACC_CALIBRATION:
                s="MSP_ACC_CALIBRATION";
                break;
            case MSP.Cmds.MAG_CALIBRATION:
                s="MSP_MAG_CALIBRATION";
                break;
            ...
            case MSP.Cmds.SET_MODE_RANGE :
                s="MSP_SET_MODE_RANGE ";
                break;
            default:
                s = "unknown %d".printf(c);
                break;
        }
        return s;
    }
