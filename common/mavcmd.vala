public class Mav : Object
{
    public enum Cmds
    {
        ...
        MAVLINK_MSG_GPS_RAW_INT_PACK = 24,
        MAVLINK_MSG_ATTITUDE_PACK = 30,
        MAVLINK_MSG_RC_CHANNELS_RAW_PACK = 35,
        MAVLINK_MSG_GPS_GLOBAL_ORIGIN_PACK = 49,
        MAVLINK_MSG_VFR_HUD_PACK = 74,
