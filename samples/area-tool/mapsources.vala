...
{
    private const string BURI0="https://dev.virtualearth.net/REST/V1/Imagery/Metadata/";
    private const string BURI1="/0,0?zl=1&include=ImageryProviders&key=";
    ...
    {
        StringBuilder sb = new StringBuilder(BURI0);
        var aerial = Environment.get_variable("BING_VIEW");
        if (aerial == null)
            aerial = "Aerial";
        sb.append(aerial);
        sb.append(BURI1);
